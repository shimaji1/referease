...
export default function NewProviderPage() {
  ...
  const handleSubmit = async (data) => {
    ...
    router.push(`/dashboard/provider/${created.id}?created=1`)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <p className="text-sm text-gray-500 mb-4">Add your practice or clinic to ReferEasy so physicians can find and refer patients to you.</p>
        <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 mb-6 text-sm text-blue-900">
          <strong>After you create your listing</strong>, you'll be taken to the edit page where you can upload referral forms, add multiple locations, and preview how referring physicians will see your profile.
        </div>
