...
export default function ProviderForm({ initial, onSubmit, loading, submitLabel }) {
  const empty = {
    name: '', type: '', category: 'specialist', services: [], address: '', phone: '', fax: '', website: '',
    ...
    <div className="space-y-6">
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label className={lbl}>Specialty / Type *</label>
            <input className={inp} value={form.type} onChange={e => set('type', e.target.value)} placeholder="e.g. Dermatology, Cardiology" />
          </div>
          <div>
